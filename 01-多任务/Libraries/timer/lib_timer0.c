...
void lib_timer0_init() {
    ...
    afio_cfg(__TIMERx_AF, TIMER0_CH0_P_GPIO_RCU, TIMER0_CH0_P_GPIO_PORT, TIMER0_CH0_P_GPIO_PIN);
#endif
#if USE_LIB_TIMER0_CH0_N
    afio_cfg(__TIMERx_AF, TIMER0_CH0_N_GPIO_RCU, TIMER0_CH0_N_GPIO_PORT, TIMER0_CH0_N_GPIO_PIN);
#endif
    // CH 1
#if USE_LIB_TIMER0_CH1_P
    afio_cfg(__TIMERx_AF, TIMER0_CH1_P_GPIO_RCU, TIMER0_CH1_P_GPIO_PORT, TIMER0_CH1_P_GPIO_PIN);
#endif
#if USE_LIB_TIMER0_CH1_N
    afio_cfg(__TIMERx_AF, TIMER0_CH1_N_GPIO_RCU, TIMER0_CH1_N_GPIO_PORT, TIMER0_CH1_N_GPIO_PIN);
#endif
    // CH 2
#if USE_LIB_TIMER0_CH2_P
    afio_cfg(__TIMERx_AF, TIMER0_CH2_P_GPIO_RCU, TIMER0_CH2_P_GPIO_PORT, TIMER0_CH2_P_GPIO_PIN);
#endif
#if USE_LIB_TIMER0_CH2_N
    afio_cfg(__TIMERx_AF, TIMER0_CH2_N_GPIO_RCU, TIMER0_CH2_N_GPIO_PORT, TIMER0_CH2_N_GPIO_PIN);
#endif
    // CH 3
#if USE_LIB_TIMER0_CH3
    afio_cfg(__TIMERx_AF, TIMER0_CH3_GPIO_RCU, TIMER0_CH3_GPIO_PORT, TIMER0_CH3_GPIO_PIN);
#endif
    ...
    /// timer init
    lib_timer0_update_period(TIMER0_PRESCALER, TIMER0_FREQ);
