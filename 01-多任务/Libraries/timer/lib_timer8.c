...
void lib_timer8_init() {
    ...
    afio_cfg(__TIMERx_AF, TIMER8_CH0_GPIO_RCU, TIMER8_CH0_GPIO_PORT, TIMER8_CH0_GPIO_PIN);
#endif
    // CH 1
#if USE_LIB_TIMER8_CH1
    afio_cfg(__TIMERx_AF, TIMER8_CH1_GPIO_RCU, TIMER8_CH1_GPIO_PORT, TIMER8_CH1_GPIO_PIN);
#endif
    ...
    /// timer init
    lib_timer8_update_period(TIMER8_PRESCALER, TIMER8_FREQ);
