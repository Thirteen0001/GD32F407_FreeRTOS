...
void lib_timer11_init() {
    ...
    afio_cfg(__TIMERx_AF, TIMER11_CH0_GPIO_RCU, TIMER11_CH0_GPIO_PORT, TIMER11_CH0_GPIO_PIN);
#endif
    // CH 1
#if USE_LIB_TIMER11_CH1
    afio_cfg(__TIMERx_AF, TIMER11_CH1_GPIO_RCU, TIMER11_CH1_GPIO_PORT, TIMER11_CH1_GPIO_PIN);
#endif
    ...
    /// timer init
    lib_timer11_update_period(TIMER11_PRESCALER, TIMER11_FREQ);
