...
void lib_timer4_init() {
    ...
    afio_cfg(__TIMERx_AF, TIMER4_CH0_GPIO_RCU, TIMER4_CH0_GPIO_PORT, TIMER4_CH0_GPIO_PIN);
#endif
    // CH 1
#if USE_LIB_TIMER4_CH1
    afio_cfg(__TIMERx_AF, TIMER4_CH1_GPIO_RCU, TIMER4_CH1_GPIO_PORT, TIMER4_CH1_GPIO_PIN);
#endif
    // CH 2
#if USE_LIB_TIMER4_CH2
    afio_cfg(__TIMERx_AF, TIMER4_CH2_GPIO_RCU, TIMER4_CH2_GPIO_PORT, TIMER4_CH2_GPIO_PIN);
#endif
    // CH 3
#if USE_LIB_TIMER4_CH3
    afio_cfg(__TIMERx_AF, TIMER4_CH3_GPIO_RCU, TIMER4_CH3_GPIO_PORT, TIMER4_CH3_GPIO_PIN);
#endif
    ...
    /// timer init
    lib_timer4_update_period(TIMER4_PRESCALER, TIMER4_FREQ);
