...
void lib_timer2_init() {
    ...
    afio_cfg(__TIMERx_AF, TIMER2_CH0_GPIO_RCU, TIMER2_CH0_GPIO_PORT, TIMER2_CH0_GPIO_PIN);
#endif
    // CH 1
#if USE_LIB_TIMER2_CH1
    afio_cfg(__TIMERx_AF, TIMER2_CH1_GPIO_RCU, TIMER2_CH1_GPIO_PORT, TIMER2_CH1_GPIO_PIN);
#endif
    // CH 2
#if USE_LIB_TIMER2_CH2
    afio_cfg(__TIMERx_AF, TIMER2_CH2_GPIO_RCU, TIMER2_CH2_GPIO_PORT, TIMER2_CH2_GPIO_PIN);
#endif
    // CH 3
#if USE_LIB_TIMER2_CH3
    afio_cfg(__TIMERx_AF, TIMER2_CH3_GPIO_RCU, TIMER2_CH3_GPIO_PORT, TIMER2_CH3_GPIO_PIN);
#endif
    ...
    /// timer init
    lib_timer2_update_period(TIMER2_PRESCALER, TIMER2_FREQ);
