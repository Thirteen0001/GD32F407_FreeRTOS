...
#define SPI0_DMA_TX_ENABLE	0
#if SPI0_DMA_TX_ENABLE
#define SPI0_DMA_TX_NVIC	1, 2
#endif
...
#define SPI0_PARAM_PSC		SPI_PSC_2
//极性和相位：
...
#define SPI2_DMA_TX_ENABLE	1
#if SPI2_DMA_TX_ENABLE
#define SPI2_DMA_TX_NVIC	1, 2
#endif
